...
usage() {
    ...
    echo "         -m experimental_experiment.torch_bench.bash_bench_huggingface --device cuda --dtype float16 --quiet 1 --memory_peak 1 --exporter script,dynamo2,custom --model All -r 30 -w 10 --verbose 1 --dump_ort 1"
    echo
