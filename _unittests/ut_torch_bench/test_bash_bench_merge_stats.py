...
class TestBashBenchMergeStats(ExtTestCase):
    ...
    def test_merge_stats0(self):
        ...
        df = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats0.xlsx"),
            export_simple=self.get_dump_file("test_merge_stats0_simple.csv"),
            export_correlations=self.get_dump_file("test_merge_stats0_corrs.xlsx"),
        )
    ...
    def test_merge_stats1(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats1.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
    ...
    def test_merge_stats3(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats3.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
    ...
    def test_merge_stats_gpu_mem(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_gpu_mem.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_gpu_big(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_gpu_big.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_duplicate(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_duplicate.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        # self.assertIn("memory", set(df))
    ...
    def test_merge_stats_bug_timm(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_bug_timm.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_bug_one_export(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_bug_one_export.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_bug_op_onnx(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_bug_op_onnx.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_empty(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_empty.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_bug_speedup_summary(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_bug_speedup_summary.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_bug_cpu_cuda(self):
        ...
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_bug_cpu_cuda.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
    ...
    def test_merge_stats_filter(self):
        ...
        df1 = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_filter1.xlsx"),
            filter_in="device:cpu;cuda",
        )
        df2 = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_filter2.xlsx"),
            filter_in="device:cuda",
        )
        df3 = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_filter3.xlsx"),
            filter_out="device:cuda",
        )
    ...
    def test_merge_stats_filter_hg(self):
        ...
        df = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_filter_hg.xlsx"),
        ...
        df = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_filter_hg_none.xlsx"),
    ...
    def test_merge_stats_diff(self):
        ...
        dfs = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_diff.xlsx"),
            baseline=base,
        )
    ...
    def test_merge_stats_broken(self):
        ...
        dfs = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_broken.xlsx"),
            broken=True,
        )
    ...
    def test_merge_stats_subset(self):
        ...
        dfs = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_subset.xlsx"),
            slow=0.9,
            fast=1.1,
            slow_script=0.9,
            fast_script=1.1,
    ...
    def test_merge_stats_bug_merge_gr(self):
        ...
        dfs = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_bug_merge_gr.xlsx"),
            export_simple=self.get_dump_file("test_merge_stats_bug_merge_gr_simple.csv"),
    ...
    def test_merge_stats_fix_report(self):
        ...
        dfs = merge_benchmark_reports(
            data,
            excel_output=self.get_dump_file("test_merge_stats_fix_report.xlsx"),
            export_simple=self.get_dump_file("test_merge_stats_fix_report.csv"),
            keys=tuple(c for c in keys if c not in {"version_python"}),
        )
        self.assertNotEmpty(dfs)
    ...
    def test_build_historical_report(self):
        ...
        build_historical_report(
            self.get_dump_file("test_build_historical_report.xlsx"), data, verbose=1
        )

    @ignore_warnings((PerformanceWarning, FutureWarning))
    def test_merge_stats_model_task(self):
        ddata = os.path.join(os.path.dirname(__file__), "data")
        data = [os.path.join(ddata, "huggingface_benchmark_v100_custom_task.csv")]
        df = merge_benchmark_reports(
            data, excel_output=self.get_dump_file("test_merge_stats_model_task.xlsx")
        )
        self.assertIsInstance(df, dict)
        self.assertIn("status", set(df))
        self.assertIn("memory", set(df))
